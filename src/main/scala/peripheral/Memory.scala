...
object BlockRAMVerilogGenerator extends App {
  (new ChiselStage).execute(Array("-X", "verilog", "-td", "verilog/Memory"), Seq(ChiselGeneratorAnnotation(() => new peripheral.BlockRAM(1024))))
}