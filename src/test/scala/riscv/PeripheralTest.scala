...
object UartVerilogGenerator extends App {
  (new ChiselStage).execute(Array("-X", "verilog", "-td", "verilog/uart"), Seq(ChiselGeneratorAnnotation(() => new peripheral.Uart(50000000,19200))))
}
